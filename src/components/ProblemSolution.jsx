...
export default function ProblemSolution() {
  ...
  const solutions = [
    {
      ...
      description: "Mulai dari 499K sebelum diskon dengan kualitas premium",
  ...
  return (
    <section
      id="problem-solution"
      className="section bg-gradient-to-r from-gray-50 to-white"
    >
      <div className="container">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-xl text-graytext-700 max-w-3xl mx-auto">
            Kami paham betul masalah yang sering dihadapi UMKM. Itulah kenapa
            kami hadir dengan solusi yang berbeda.
          </p>
        </div>
        ...
        <div className="mb-16" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {problems.map((problem, idx) => (
              <div
                key={idx}
                className="card border-l-4 border-red-500 hover:border-red-600 transition-colors"
              >
                <div className="text-4xl mb-4">{problem.icon}</div>
                <h4 className="text-xl font-semibold mb-3 text-graytext-900">
                  {problem.title}
                </h4>
        ...
        <div className="mb-16" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {solutions.map((solution, idx) => (
              <div
                key={idx}
                className="card border-l-4 border-green-500 hover:border-green-600 transition-colors bg-gradient-to-br from-green-50 to-white"
              >
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  <th className="text-left py-4 px-4 font-semibold text-graytext-900">
                    Fitur
                  </th>
